...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        <meta charset="UTF-8">
        <title>利用規約 | 歴史年表 Only View Chronology</title>
...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head prefix="og: https://ogp.me/ns#">
        <meta charset="UTF-8">
        <title>利用規約 | 歴史年表 Only View Chronology 見るだけで歴史がわかる・面白くなる</title>
		...
		<meta property="og:url" content="https://only-view-chronology.herokuapp.com/tos" />
        ...
        <div id="container">
            ...
            <div id="content-area">
                ...
                <main id="tos-page">
                    <div class='tos'>
                        <h1>利用規約</h1>
                        <p>この利用規約（以下，「本規約」といいます。）は，歴史年表 | Only View Chronology（以下，「当社」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。</p>
                        <h2>第1条（適用）</h2>
                        ...
                        <h2>第2条（利用登録）</h2>
                            ...
                            <dl>2. 当社は，利用登録の申請者に以下の事由があると判断した場合，利用登録の申請を承認しないことがあり，その理由については一切の開示義務を負わないものとします。</dl>
                                <dd>1. 利用登録の申請に際して虚偽の事項を届け出た場合</dd>
                                <dd>2. 本規約に違反したことがある者からの申請である場合</dd>
                                <dd>3. その他，当社が利用登録を相当でないと判断した場合</dd>
                        ...
                        <h2>第5条（禁止事項）</h2>
                            <dl>1. ユーザーは，本サービスの利用にあたり，以下の行為をしてはなりません。</dl>
                                <dd>1. 法令または公序良俗に違反する行為</dd>
                                <dd>2. 犯罪行為に関連する行為</dd>
                                <dd>3. 本サービスの内容等，本サービスに含まれる著作権，商標権ほか知的財産権を侵害する行為</dd>
                                <dd>4. 当社，ほかのユーザー，またはその他第三者のサーバーまたはネットワークの機能を破壊したり，妨害したりする行為</dd>
                                <dd>5. 本サービスによって得られた情報を商業的に利用する行為</dd>
                                <dd>6. 当社のサービスの運営を妨害するおそれのある行為</dd>
                                <dd>7. 不正アクセスをし，またはこれを試みる行為</dd>
                                <dd>8. 他のユーザーに関する個人情報等を収集または蓄積する行為</dd>
                                <dd>9. 不正な目的を持って本サービスを利用する行為</dd>
                                <dd>10. 本サービスの他のユーザーまたはその他の第三者に不利益，損害，不快感を与える行為</dd>
                                <dd>11. 他のユーザーに成りすます行為</dd>
                                <dd>12. 当社が許諾しない本サービス上での宣伝，広告，勧誘，または営業行為</dd>
                                <dd>13. 面識のない異性との出会いを目的とした行為</dd>
                                <dd>14. 当社のサービスに関連して，反社会的勢力に対して直接または間接に利益を供与する行為</dd>
                                <dd>15. その他，当社が不適切と判断する行為</dd>
                        <h2>第6条（本サービスの提供の停止等）</h2>
                            <dl>1. 当社は，以下のいずれかの事由があると判断した場合，ユーザーに事前に通知することなく本サービスの全部または一部の提供を停止または中断することができるものとします。</dl>
                                <dd>1. 本サービスにかかるコンピュータシステムの保守点検または更新を行う場合</dd>
                                <dd>2. 地震，落雷，火災，停電または天災などの不可抗力により，本サービスの提供が困難となった場合</dd>
                                <dd>3. コンピュータまたは通信回線等が事故により停止した場合</dd>
                                <dd>4. その他，当社が本サービスの提供が困難と判断した場合</dd>
                            <p>2. 当社は，本サービスの提供の停止または中断により，ユーザーまたは第三者が被ったいかなる不利益または損害についても，一切の責任を負わないものとします。</p>
                        <h2>第7条（利用制限および登録抹消）</h2>
                            <dl>1. 当社は，ユーザーが以下のいずれかに該当する場合には，事前の通知なく，ユーザーに対して，本サービスの全部もしくは一部の利用を制限し，またはユーザーとしての登録を抹消することができるものとします。</dl>
                                <dd>1. 本規約のいずれかの条項に違反した場合</dd>
                                <dd>2. 登録事項に虚偽の事実があることが判明した場合</dd>
                                <dd>3. 料金等の支払債務の不履行があった場合</dd>
                                <dd>4. 当社からの連絡に対し，一定期間返答がない場合</dd>
                                <dd>5. 本サービスについて，最終の利用から一定期間利用がない場合</dd>
                                <dd>6. その他，当社が本サービスの利用を適当でないと判断した場合</dd>
                        ...
                        <h2>第11条（利用規約の変更）</h2>
                            <dl>1. 当社は以下の場合には、ユーザーの個別の同意を要せず、本規約を変更することができるものとします。</dl>
                                <dd>1. 本規約の変更がユーザーの一般の利益に適合するとき。</dd>
                                <dd>2. 本規約の変更が本サービス利用契約の目的に反せず、かつ、変更の必要性、変更後の内容の相当性その他の変更に係る事情に照らして合理的なものであるとき。</dd>

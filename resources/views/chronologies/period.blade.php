...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head prefix="og: https://ogp.me/ns#">
        <meta charset="UTF-8">
        <title>時代別年表 | 歴史年表 Only View Chronology 見るだけで歴史がわかる・面白くなる</title>
        ...
        <meta property="og:title" content="時代ごとの年表が見られます" />
		<meta property="og:description" content="毎日が歴史上の出来事の記念日。身近な人の誕生日と同じ日にあった出来事を知ることで、歴史との距離を縮めます。" />
		<meta property="og:type" content="article" />
		<meta property="og:url" content="https://only-view-chronology.herokuapp.com/period" />
